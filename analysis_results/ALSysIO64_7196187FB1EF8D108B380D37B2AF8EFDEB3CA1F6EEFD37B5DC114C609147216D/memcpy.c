...

{
  ...
  if (_Src < _Dst) {
    ...
    while (uVar6 = _Size >> 5, puVar3 = puVar4, uVar6 != 0) {
      if ((uVar6 < 0x2000) || (0xfffffffffffff000 < uVar5)) goto LAB_00013a80;
      do {
        iVar2 = 0x20;
        do {
          puVar3 = puVar4;
  ...
  while (uVar6 = _Size >> 5, puVar4 = puVar3, uVar6 != 0) {
    if ((uVar6 < 0x2000) || (uVar5 < 0x1000)) goto LAB_000138e0;
    do {
      iVar2 = 0x20;
      do {
        puVar4 = puVar3;
