...
int FUN_00011620(undefined8 param_1,longlong param_2,longlong param_3,ulonglong param_4)
          ...
          if (local_d0[0] == 0) {
            if (cVar5 == '\0') {
              ...
              iVar3 = ZwMapViewOfSection(local_b8,0xffffffffffffffff,&local_88,0,
                                         local_b0 & 0xffffffff,&local_c0,&local_b0,1,0,4);
              if (iVar3 < 0) goto LAB_00011955;
...
LAB_00011943:
    ...
    if ((0x17 < *(uint *)(param_3 + 0x10)) &&
       (piVar6 = piVar1, piVar7 = local_98, 3 < *(uint *)(param_3 + 8))) goto LAB_000116b4;
    iVar3 = -0x3fffff66;
LAB_00011676:
    if (cVar5 != '\0') {
      if (local_d8 == 0) {
