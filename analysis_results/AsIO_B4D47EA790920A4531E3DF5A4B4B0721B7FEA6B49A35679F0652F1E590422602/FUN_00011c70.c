...
int FUN_00011c70(undefined8 param_1,char *param_2)

{
  ...
  iVar5 = -0x3ffffffe;
  cVar1 = *pcVar9;
  if ((cVar1 == '\0') || (cVar1 == '\x02')) goto switchD_00011df5_caseD_a040a48c;
  if (cVar1 != '\x0e') goto switchD_00011df5_caseD_a040a461;
  ...
  if (uVar2 < 0xa040a45d) {
    if (uVar2 == 0xa040a45c) {
      ...
      goto switchD_00011df5_caseD_a040a461;
    }
    if (0xa0406408 < uVar2) {
      if (uVar2 == 0xa0406458) {
        ...
        uVar7 = FUN_00011470((longlong)param_2,(longlong)pcVar9,bVar4);
        iVar5 = (int)uVar7;
      }
      goto switchD_00011df5_caseD_a040a461;
    }
    if (uVar2 != 0xa0406408) {
      if (uVar2 == 0xa040244c) goto switchD_00011df5_caseD_a040a480;
      if (uVar2 == 0xa0402450) {
        if (bVar4 == 0) {
          if (*(uint *)(pcVar9 + 0x10) < 8) goto LAB_00011d47;
...
LAB_00011d47:
      ...
      if ((uVar2 != 0xa0406400) && (uVar2 != 0xa0406404)) goto switchD_00011df5_caseD_a040a461;
    }
    ...
    case 0xa040a464:
      ...
      break;
    case 0xa040a480:
switchD_00011df5_caseD_a040a480:
      pcVar8 = param_2;
      iVar5 = FUN_00011620(param_1,(longlong)param_2,(longlong)pcVar9,(ulonglong)bVar4);
      pcVar9 = pcVar8;
      if (iVar5 < 0) {
        param_2[0x30] = '\r';
        param_2[0x31] = '\0';
    ...
    case 0xa040a488:
      ...
      *puVar3 = local_38;
      ...
      param_2[0x3f] = '\0';
    case 0xa040a48c:
switchD_00011df5_caseD_a040a48c:
      iVar5 = 0;
      break;
    case 0xa040a540:
    case 0xa040a544:
    case 0xa040a548:
      uVar7 = FUN_00011a20((longlong)param_2,(longlong)pcVar9,bVar4);
      iVar5 = (int)uVar7;
    }
  }
switchD_00011df5_caseD_a040a461:
