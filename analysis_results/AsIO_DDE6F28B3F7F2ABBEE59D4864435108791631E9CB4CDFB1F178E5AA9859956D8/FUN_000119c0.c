// Function: FUN_000119c0
// Address: 000119c0
// Decompiled by Ghidra


int FUN_000119c0(undefined8 param_1,char *param_2)

{
  ...
  iVar5 = -0x3ffffffe;
  cVar1 = *pcVar9;
  if ((cVar1 == '\0') || (cVar1 == '\x02')) goto switchD_00011b15_caseD_a040a48c;
  if (cVar1 != '\x0e') goto switchD_00011b15_caseD_a040a449;
  uVar2 = *(uint *)(pcVar9 + 0x18);
  if (uVar2 < 0xa040a445) {
    if (uVar2 != 0xa040a444) {
      if (uVar2 < 0xa0406405) {
        if (uVar2 != 0xa0406404) {
          if (uVar2 == 0xa040244c) goto switchD_00011b15_caseD_a040a480;
          if (uVar2 == 0xa0402450) {
            if (bVar4 == 0) {
              if (*(uint *)(pcVar9 + 0x10) < 8) goto LAB_00011a90;
...
LAB_00011a90:
                iVar5 = -0x3fffff66;
                goto switchD_00011b15_caseD_a040a449;
              }
          ...
          if (uVar2 != 0xa0406400) goto switchD_00011b15_caseD_a040a449;
        }
      }
        ...
        if (uVar2 != 0xa040a440) goto switchD_00011b15_caseD_a040a449;
        goto switchD_00011b15_caseD_a040a448;
      }
      uVar7 = FUN_00011260((longlong)param_2,(longlong)pcVar9);
      iVar5 = (int)uVar7;
      goto switchD_00011b15_caseD_a040a449;
    }
switchD_00011b15_caseD_a040a448:
    ...
    case 0xa040a464:
      ...
      break;
    case 0xa040a480:
switchD_00011b15_caseD_a040a480:
      pcVar8 = param_2;
    ...
    case 0xa040a488:
      ...
      *puVar3 = local_38;
      ...
      param_2[0x3f] = '\0';
    case 0xa040a48c:
switchD_00011b15_caseD_a040a48c:
      iVar5 = 0;
    }
  }
switchD_00011b15_caseD_a040a449:
