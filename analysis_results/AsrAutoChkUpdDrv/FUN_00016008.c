...

{
  ...
  RtlInitUnicodeString(local_28,u__Device_AsrAutoChkUpdDrv_00016180);
  RtlInitUnicodeString(local_18,u__DosDevices_AsrAutoChkUpdDrv_000161c0);
