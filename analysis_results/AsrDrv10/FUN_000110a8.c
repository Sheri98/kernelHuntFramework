...

{
  ...
  *(undefined8 *)(param_2 + 0x38) = 0;
  if (**(char **)(param_2 + 0xb8) != '\x0e') goto LAB_00011949;
  uVar17 = *(uint *)(*(char **)(param_2 + 0xb8) + 0x18);
  if (uVar17 < 0x222859) {
    if (uVar17 == 0x222858) {
      uVar11 = FUN_00011aec((short *)puVar3);
...
LAB_000112b8:
        ...
        if (uVar17 != 0x222840) {
          ...
          if (uVar17 == 0x222848) {
            ...
            *(int *)((longlong)puVar3 + 0xc) = (int)((ulonglong)uVar12 >> 0x20);
            ...
            if (uVar17 != 0x222850) goto LAB_00011884;
  ...
  if (uVar17 < 0x22287d) {
    if (uVar17 == 0x22287c) {
      uVar12 = FUN_00011e64((longlong)puVar3);
      iVar9 = (int)uVar12;
      goto LAB_00011898;
    }
    if (uVar17 != 0x22285c) {
      if (uVar17 == 0x222860) {
        uVar11 = FUN_00011fbc((uint *)puVar3);
        *(int *)(param_2 + 0x30) = (int)uVar11;
        if (-1 < (int)uVar11) {
      ...
      if (uVar17 == 0x222864) {
        ...
        *puVar3 = uVar11;
        ...
        if (uVar17 != 0x222874) {
          if (uVar17 != 0x222878) goto LAB_00011884;
          uVar12 = FUN_00011d84((longlong)puVar3);
          iVar9 = (int)uVar12;
          goto LAB_00011898;
        }
        lVar18 = 2;
...
LAB_0001118f:
    ...
    *(undefined4 *)(param_2 + 0x30) = 0;
    ...
    if (uVar17 == 0x222880) {
      uVar12 = FUN_00011f48((undefined4 *)puVar3);
      *(int *)(param_2 + 0x30) = (int)uVar12;
      if ((int)uVar12 < 0) goto LAB_00011949;
LAB_00011941:
      *(undefined8 *)(param_2 + 0x38) = 0x10;
      goto LAB_00011949;
    }
    ...
    if ((uVar17 == 0x22288c) || (uVar17 == 0x222890)) {
      uVar12 = FUN_000122b4(*(longlong *)(param_1 + 0x40),(int *)puVar3,uVar17,param_2);
      iVar9 = (int)uVar12;
LAB_00011220:
      *(int *)(param_2 + 0x30) = iVar9;
      goto LAB_00011949;
    ...
    if (uVar17 == 0x222894) {
      iVar9 = FUN_00011984((longlong *)puVar3);
      *(int *)(param_2 + 0x30) = iVar9;
      if (-1 < iVar9) {
