...

{
  ...
  *(undefined8 *)(param_2 + 0x38) = 0;
  if (**(char **)(param_2 + 0xb8) != '\x0e') goto LAB_000118ac;
  uVar16 = *(uint *)(*(char **)(param_2 + 0xb8) + 0x18);
  if (uVar16 < 0x222859) {
    if (uVar16 == 0x222858) {
      uVar10 = FUN_00011a50((short *)puVar3);
...
LAB_000117e4:
  ...
  if (uVar16 < 0x22287d) {
    if (uVar16 == 0x22287c) {
      uVar11 = FUN_00011dc8((longlong)puVar3);
      iVar8 = (int)uVar11;
      goto LAB_000117f8;
    }
    if (uVar16 != 0x22285c) {
      if (uVar16 == 0x222860) {
        uVar10 = FUN_00011f24((uint *)puVar3);
        *(int *)(param_2 + 0x30) = (int)uVar10;
        if (-1 < (int)uVar10) {
      ...
      if (uVar16 == 0x222864) {
        ...
        *puVar3 = uVar10;
        ...
        if (uVar16 != 0x222874) {
          ...
          uVar11 = FUN_00011ce8((longlong)puVar3);
          iVar8 = (int)uVar11;
          goto LAB_000117f8;
        }
        lVar17 = 2;
...
LAB_00011153:
    ...
    *(undefined4 *)(param_2 + 0x30) = 0;
    ...
    if (uVar16 == 0x222880) {
      uVar11 = FUN_00011eac((undefined4 *)puVar3);
      *(int *)(param_2 + 0x30) = (int)uVar11;
      if ((int)uVar11 < 0) goto LAB_000118ac;
LAB_000118a4:
      *(undefined8 *)(param_2 + 0x38) = 0x10;
      goto LAB_000118ac;
    }
    if (uVar16 == 0x222884) {
      MmFreeContiguousMemorySpecifyCache(puVar3[1],(int)*puVar3,1);
      goto LAB_000118ac;
    }
    if (uVar16 == 0x222888) {
    ...
    if ((uVar16 == 0x22288c) || (uVar16 == 0x222890)) {
      uVar11 = FUN_00012220(*(longlong *)(param_1 + 0x40),(int *)puVar3,uVar16,param_2);
      iVar8 = (int)uVar11;
LAB_000111e4:
      *(int *)(param_2 + 0x30) = iVar8;
      goto LAB_000118ac;
    ...
    if (uVar16 == 0x222894) {
      iVar8 = FUN_000118e8((longlong *)puVar3);
      *(int *)(param_2 + 0x30) = iVar8;
      if (-1 < iVar8) {
