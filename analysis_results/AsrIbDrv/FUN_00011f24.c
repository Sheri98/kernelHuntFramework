// Function: FUN_00011f24
// Address: 00011f24
// Decompiled by Ghidra


ulonglong FUN_00011f24(uint *param_1)

{
  ...
  if (lVar5 == 0) {
    ...
    if (((byte)*(undefined4 *)(lVar9 + 0x128 + lVar5) & 0xf) == 3) {
      local_38 = 0xe00;
      uVar6 = FUN_00011eac(&local_38);
      uVar8 = uVar6 & 0xffffffff;
      if (-1 < (int)uVar6) {
        FUN_00012510(local_30,0,0xe00);
...
LAB_0001210c:
        ...
        MmFreeContiguousMemorySpecifyCache(local_30,local_38,1);
        uVar8 = uVar7;
      }
    }
    else {
