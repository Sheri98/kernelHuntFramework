// Function: FUN_00012214
// Address: 00012214
// Decompiled by Ghidra


undefined8 FUN_00012214(longlong param_1,int *param_2,int param_3,longlong param_4)

{
  ...
  if (plVar3 != plVar5) {
    do {
      plVar6 = plVar3 + -0x45;
      if ((int)*plVar6 == *param_2) goto LAB_00012250;
