// Function: FUN_00011400
// Address: 00011400
// Decompiled by Ghidra


ulonglong FUN_00011400(longlong param_1)

{
  ...
  if (DAT_00014060 == '\0') {
    if (uVar1 <= uVar4) goto LAB_00011444;
  }
  else if ((uVar1 <= uVar4) &&
          (uVar2 = (ulonglong)(-DAT_0001405c - 1U), uVar4 <= -DAT_0001405c - 1U)) goto LAB_00011444;
  ...
  if (uVar1 == 0) {
    ...
    if (DAT_00014040 != 0) {
      ...
      *puVar3 = DAT_00014038;
      ...
      if (*(char *)(puVar3 + 4) == '\0') goto LAB_00011444;
    }
