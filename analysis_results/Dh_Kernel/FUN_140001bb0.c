...
ulonglong FUN_140001bb0(longlong param_1)
    ...
    if ((undefined8 **)DAT_1400040c8 == &DAT_1400040c8) {
      ...
      while( true ) {
        if (DAT_1400040b8 == puVar12) {
          *(undefined8 *)((longlong)puVar11 + -8) = 0x140001c68;
          RtlInitUnicodeString
                    ((undefined1 *)((longlong)puVar11 + 0x20),L"\\DosDevices\\DianHuRing0");
          *(undefined8 *)((longlong)puVar11 + -8) = 0x140001c73;
          IoDeleteSymbolicLink((undefined1 *)((longlong)puVar11 + 0x20));
          uVar3 = *(undefined8 *)(param_1 + 8);
          *(undefined8 *)((longlong)puVar11 + -8) = 0x140001c7d;
          IoDeleteDevice(uVar3);
          *(undefined8 *)((longlong)puVar11 + -8) = 0x140001c8a;
          uVar7 = FUN_140001f20(*(ulonglong *)((longlong)puVar11 + 0x30) ^ (ulonglong)puVar11);
          return uVar7;
        }
LAB_140001c26:
      ...
      *puVar11 = puVar12;
      ...
      if ((*(longlong *)(lVar10 + 0xb8) != 0) &&
        ...
        if ((uint)((ulonglong)uVar9 * 0x780ed4c7 >> 0x3e) * 0x77885545 + uVar9 == piVar4[0xb]) {
          puVar11[-5] = 0x140001d26;
          uVar9 = FUN_1400016f8((undefined8 *)piVar4);
          uVar7 = (ulonglong)uVar9;
        }
      }
      *(undefined8 *)(lVar10 + 0x38) = 0;
      *(int *)(lVar10 + 0x30) = (int)uVar7;
      puVar11[-5] = 0x140001d3b;
