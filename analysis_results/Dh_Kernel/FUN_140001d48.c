// Function: FUN_140001d48
// Address: 140001d48
// Decompiled by Ghidra


void FUN_140001d48(undefined8 *param_1)

{
  ...
  if (-1 < iVar2) {
    ...
    if (iVar2 < 0) {
      ...
      if (puVar3 == (undefined8 *)0x0) {
        ...
        lVar4 = FUN_14000163c(*(longlong *)((longlong)param_1 + 0xc),&local_60,
  ...
  FUN_140001f20(local_18 ^ (ulonglong)auStack_88);
  return;
}
