// Function: FUN_140002180
// Address: 140002180
// Decompiled by Ghidra


undefined8 * FUN_140002180(undefined8 *param_1,undefined8 *param_2,ulonglong param_3)
  ...
  if (param_2 < param_1) {
    ...
    if (0x4e < param_3) {
      ...
      if ((0x2000 < uVar12) && (uVar11 < 0xfffffffffffffe01)) {
        ...
        UNLOCK();
        uVar12 = param_3 >> 5;
        if (uVar12 == 0) goto LAB_140002337;
      }
...
LAB_140002337:
  ...
  if (0x4e < param_3) {
    ...
    if ((0x2000 < uVar12) && (0x1ff < uVar11)) {
      ...
      UNLOCK();
      uVar12 = param_3 >> 5;
      if (uVar12 == 0) goto LAB_140002192;
    }
    param_3 = param_3 & 0x1f;
    puVar10 = puVar9;
    do {
