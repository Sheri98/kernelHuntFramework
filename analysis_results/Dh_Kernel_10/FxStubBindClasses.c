...
/* WARNING: Removing unreachable block (ram,0x000140001f9f) */
...

{
  ...
  while( true ) {
    ...
    if (*(code **)(piVar2 + 0xe) == (code *)0x0) {
      iVar1 = WdfVersionBindClass(param_1,DAT_1400040f8,piVar2);
    }
    else {
      iVar1 = (**(code **)(piVar2 + 0xe))(WdfVersionBindClass,param_1,DAT_1400040f8,piVar2);
    }
    if (iVar1 < 0) {
      return iVar1;
    }
