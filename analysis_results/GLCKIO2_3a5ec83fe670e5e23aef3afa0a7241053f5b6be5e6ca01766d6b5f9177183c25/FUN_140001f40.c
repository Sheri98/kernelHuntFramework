// Function: FUN_140001f40
// Address: 140001f40
// Decompiled by Ghidra


undefined8 * FUN_140001f40(undefined8 *param_1,undefined8 *param_2,ulonglong param_3)
  ...
  if (param_2 < param_1) {
    ...
    if (0x4e < param_3) {
      ...
      if ((0x2000 < uVar12) && (uVar11 < 0xfffffffffffffe01)) {
        ...
        UNLOCK();
        uVar12 = param_3 >> 5;
        if (uVar12 == 0) goto LAB_1400020f7;
      }
...
LAB_1400020f7:
  ...
  if (0x4e < param_3) {
    ...
    if ((0x2000 < uVar12) && (0x1ff < uVar11)) {
      ...
      UNLOCK();
      uVar12 = param_3 >> 5;
      if (uVar12 == 0) goto LAB_140001f52;
    }
    param_3 = param_3 & 0x1f;
    puVar10 = puVar9;
    do {
