...

{
  ...
  local_res18[0] = 0;
  RtlInitUnicodeString(local_28,L"\\Device\\HwRwDrv");
  uVar2 = IoCreateDevice(param_1,0,local_28,40000,0x100,0,local_res18);
  if ((int)uVar2 < 0) {
    ...
    *(code **)(param_1 + 0x68) = FUN_00011404;
    RtlInitUnicodeString(local_18,L"\\DosDevices\\HwRwDrv");
