// Function: FUN_140002384
// Address: 140002384
// Decompiled by Ghidra


ulonglong FUN_140002384(uint param_1,longlong *param_2,uint *param_3,int param_4)

{
  ...
  _Dst = (void *)FUN_140002354(param_1);
  if ((_Dst != (void *)0x0) ||
     ((_Dst = (void *)0x0, param_4 == 1 &&
      (_Dst = (void *)FUN_1400034a8(param_1), _Dst != (void *)0x0)))) {
    local_10 = (longlong **)&local_18;
    local_18 = (longlong **)&local_18;
    _Dst = (void *)FUN_140002d4c((longlong)_Dst,(longlong *)&local_18);
    if ((char)_Dst != '\0') {
      ...
      *param_3 = uVar6;
      if (uVar6 != 0) {
        ...
        *param_2 = (longlong)_Dst;
        if (_Dst != (void *)0x0) {
          memset(_Dst,0,(ulonglong)*param_3 * 0x318);
          ppplVar7 = &local_18;
          uVar6 = 0;
          ...
          if ((longlong ***)local_18 != ppplVar7) {
            do {
              ...
              if (((char)ppplVar7 == '\0') ||
                 (ppplVar7 = (longlong ***)MmIsAddressValid(ppplVar10), (char)ppplVar7 == '\0'))
              break;
              if (uVar6 < *param_3) {
                lVar11 = 6;
                ppplVar7 = ppplVar10 + 2;
                plVar5 = (longlong *)((ulonglong)uVar6 * 0x318 + *param_2);
                do {
                  plVar9 = plVar5;
                  ppplVar8 = ppplVar7;
                  pplVar4 = ppplVar8[1];
