...

{
  ...
  local_res18[0] = 0;
  RtlInitUnicodeString(local_28,L"\\Device\\NTIOLib_MSIFrequency_CC");
  ...
  if ((int)uVar2 < 0) {
    ...
    *(code **)(param_1 + 0x68) = FUN_00011474;
    RtlInitUnicodeString(local_18,L"\\DosDevices\\NTIOLib_MSIFrequency_CC");
