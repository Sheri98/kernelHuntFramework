...

{
  ...
  if (*pcVar2 == '\0') {
    ...
    if (*pcVar2 != '\x0e') goto LAB_00011449;
    uVar9 = *(uint *)(pcVar2 + 0x18);
    if (0xc35060d4 < uVar9) {
      if (uVar9 == 0xc3506104) {
        uVar10 = FUN_00011554(*(undefined8 **)(param_2 + 0x18),*(int *)(pcVar2 + 0x10),
        ...
        if (uVar9 == 0xc3506184) {
          ...
          *puVar1 = 8;
          ...
          if (((uVar9 != 0xc350a0c8) && (uVar9 != 0xc350a0d8)) &&
            ...
            if (uVar9 == 0xc350a108) {
              uVar10 = FUN_0001161c(*(undefined8 **)(param_2 + 0x18),*(uint *)(pcVar2 + 0x10),
                                    *(undefined8 **)(param_2 + 0x18),
                                    (ulonglong)*(uint *)(pcVar2 + 8),puVar1);
              uVar12 = (uint)uVar10;
              goto LAB_00011449;
            }
            if (uVar9 != 0xc350a148) goto LAB_00011449;
      ...
      *puVar1 = uVar12;
      ...
      if (uVar9 == 0xc3502000) {
        **(undefined4 **)(param_2 + 0x18) = 0x2000000;
        ...
        if (uVar9 != 0xc3502004) {
          if (uVar9 == 0xc3502084) {
            uVar10 = FUN_000114b8(*(undefined4 **)(param_2 + 0x18),
          ...
          if (uVar9 == 0xc3502088) {
            uVar10 = FUN_000114ec(*(undefined4 **)(param_2 + 0x18));
            uVar12 = (uint)uVar10;
            goto LAB_00011449;
          }
          if (uVar9 == 0xc350208c) {
            uVar10 = FUN_00011520(*(undefined4 **)(param_2 + 0x18),
                                  (ulonglong)*(uint *)(pcVar2 + 0x10),
