...

{
  ...
  if (*pcVar2 == '\0') {
    ...
    if (*pcVar2 != '\x0e') goto LAB_00011423;
    uVar9 = *(uint *)(pcVar2 + 0x18);
    if (0xc35060d4 < uVar9) {
      if (uVar9 == 0xc3506104) {
        uVar10 = FUN_00011530(*(longlong **)(param_2 + 0x18),*(int *)(pcVar2 + 0x10),
                              (undefined4 *)*(longlong **)(param_2 + 0x18),*(uint *)(pcVar2 + 8),
                              puVar1);
        uVar12 = (uint)uVar10;
        goto LAB_00011423;
      }
      if (uVar9 == 0xc3506144) {
        ...
        if ((((uVar9 == 0xc350a0c8) || (uVar9 == 0xc350a0d8)) || (uVar9 == 0xc350a0dc)) ||
           (uVar9 == 0xc350a0e0)) {
        ...
        if (uVar9 == 0xc350a108) {
          uVar10 = FUN_00011614(*(undefined8 **)(param_2 + 0x18),*(uint *)(pcVar2 + 0x10),
                                *(undefined8 **)(param_2 + 0x18),(ulonglong)*(uint *)(pcVar2 + 8),
                                puVar1);
          uVar12 = (uint)uVar10;
          goto LAB_00011423;
        }
        if (uVar9 != 0xc350a148) goto LAB_00011423;
...
LAB_00011189:
      ...
      *puVar1 = uVar12;
      ...
      if (uVar9 == 0xc3502000) {
        **(undefined4 **)(param_2 + 0x18) = 0x1000000;
      }
      else {
        if (uVar9 != 0xc3502004) {
          if (uVar9 == 0xc3502084) {
            uVar10 = FUN_00011494(*(undefined4 **)(param_2 + 0x18),
          ...
          if (uVar9 == 0xc3502088) {
            uVar10 = FUN_000114c8(*(undefined4 **)(param_2 + 0x18));
            uVar12 = (uint)uVar10;
            goto LAB_00011423;
          }
          if (uVar9 == 0xc350208c) {
            uVar10 = FUN_000114fc(*(undefined4 **)(param_2 + 0x18),
                                  (ulonglong)*(uint *)(pcVar2 + 0x10),
