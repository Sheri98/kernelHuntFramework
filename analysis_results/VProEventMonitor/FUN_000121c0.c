// Function: FUN_000121c0
// Address: 000121c0
// Decompiled by Ghidra


undefined8 * FUN_000121c0(undefined8 *param_1,undefined8 *param_2,ulonglong param_3)

{
  ...
  if (param_2 < param_1 || uVar5 == 0) {
    ...
    puVar3 = puVar4;
    if (param_3 < 8) goto LAB_000123d4;
    ...
    while (uVar6 = param_3 >> 5, puVar3 = puVar4, uVar6 != 0) {
      if ((uVar6 < 0x800) || (0xfffffffffffff000 < uVar5)) goto LAB_00012410;
      do {
        iVar2 = 0x20;
        do {
          puVar3 = puVar4;
  ...
  puVar4 = param_1;
  if (param_3 < 8) goto LAB_00012234;
  puVar3 = param_1;
  ...
  while (uVar6 = param_3 >> 5, puVar4 = puVar3, uVar6 != 0) {
    if ((uVar6 < 0x800) || (uVar5 < 0x1000)) goto LAB_00012270;
    do {
      iVar2 = 0x20;
      do {
        puVar4 = puVar3;
