...

{
  ...
  if (*pcVar2 == '\0') {
    ...
    if (*pcVar2 != '\x0e') goto LAB_00011422;
    uVar9 = *(uint *)(pcVar2 + 0x18);
    if (0x9c4060d4 < uVar9) {
      if (uVar9 == 0x9c406104) {
        uVar10 = FUN_00011530(*(undefined8 **)(param_2 + 0x18),*(int *)(pcVar2 + 0x10),
      ...
      if (uVar9 == 0x9c406144) {
        ...
        if ((((uVar9 == 0x9c40a0c8) || (uVar9 == 0x9c40a0d8)) || (uVar9 == 0x9c40a0dc)) ||
          ...
          if (uVar9 == 0x9c40a0d8) {
            ...
            if (uVar9 != 0x9c40a0e0) goto LAB_000111b1;
            out(uVar6,puVar3[1]);
          }
          goto LAB_00011420;
        }
        if (uVar9 == 0x9c40a108) {
          uVar10 = FUN_000115f8(*(undefined8 **)(param_2 + 0x18),*(uint *)(pcVar2 + 0x10),
                                *(undefined8 **)(param_2 + 0x18),(ulonglong)*(uint *)(pcVar2 + 8),
                                puVar1);
          uVar12 = (uint)uVar10;
          goto LAB_00011422;
        }
        if (uVar9 != 0x9c40a148) goto LAB_00011422;
...
LAB_00011189:
      ...
      *puVar1 = uVar12;
      ...
      if (uVar9 == 0x9c402000) {
        **(undefined4 **)(param_2 + 0x18) = 0x1020005;
      }
      else {
        if (uVar9 != 0x9c402004) {
          if (uVar9 == 0x9c402084) {
          ...
          if (((uVar9 != 0x9c4060c4) && (uVar9 != 0x9c4060cc)) && (uVar9 != 0x9c4060d0))
          goto LAB_00011422;
          goto LAB_00011189;
        }
