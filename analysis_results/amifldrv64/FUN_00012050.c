...
undefined8 * FUN_00012050(undefined8 *param_1,undefined8 *param_2,ulonglong param_3)

{
  ...
  if (param_2 < param_1 || uVar5 == 0) {
    ...
    puVar3 = puVar4;
    if (param_3 < 8) goto LAB_00012264;
    ...
    while (uVar6 = param_3 >> 5, puVar3 = puVar4, uVar6 != 0) {
      if ((uVar6 < 0x800) || (0xfffffffffffff000 < uVar5)) goto LAB_000122a0;
      do {
        iVar2 = 0x20;
        do {
          puVar3 = puVar4;
  ...
  puVar4 = param_1;
  if (param_3 < 8) goto LAB_000120c4;
  puVar3 = param_1;
  ...
  while (uVar6 = param_3 >> 5, puVar4 = puVar3, uVar6 != 0) {
    if ((uVar6 < 0x800) || (uVar5 < 0x1000)) goto LAB_00012100;
    do {
      iVar2 = 0x20;
      do {
        puVar4 = puVar3;
