...

{
  ...
  if (7 < _Size) {
    ...
    if (0x46 < _Size) {
      ...
      uVar6 = _Size >> 6;
      uVar5 = _Size >> 3 & 7;
      if (uVar5 == 0) goto LAB_140003200;
      puVar3 = puVar3 + (uVar5 - 8);
      uVar6 = uVar6 + 1;
      switch(uVar5) {
      case 2:
        goto switchD_1400031fd_caseD_2;
      case 3:
        goto switchD_1400031fd_caseD_3;
      case 4:
        goto switchD_1400031fd_caseD_4;
      case 5:
        goto switchD_1400031fd_caseD_5;
      case 6:
        goto switchD_1400031fd_caseD_6;
      case 7:
        goto switchD_1400031fd_caseD_7;
      }
      while( true ) {
        puVar3[7] = uVar4;
        puVar3 = puVar3 + 8;
...
LAB_140003200:
        *puVar3 = uVar4;
switchD_1400031fd_caseD_7:
        puVar3[1] = uVar4;
switchD_1400031fd_caseD_6:
        puVar3[2] = uVar4;
switchD_1400031fd_caseD_5:
        puVar3[3] = uVar4;
switchD_1400031fd_caseD_4:
        puVar3[4] = uVar4;
switchD_1400031fd_caseD_3:
        puVar3[5] = uVar4;
switchD_1400031fd_caseD_2:
        puVar3[6] = uVar4;
      }
