...
<<<<<<< HEAD
        ...
        cout << "\033[96m[" << (i + 1) << "/" << driverPaths.size() << "]\033[0m ";
        cout << "Service: \033[97m" << serviceName << "\033[0m" << endl;
        cout << "    Loading: " << driverPath << " ... ";
        ...
        // Add delay between driver loads to prevent BSOD
        if (i < driverPaths.size() - 1) {
...
<<<<<<< HEAD
        ...
        cout << "\033[96m[" << (i + 1) << "/" << driverFiles.size() << "]\033[0m ";
        cout << "Service: \033[97m" << serviceName << "\033[0m" << endl;
        cout << "    Loading: " << driverPath << " ... ";
